...
# ===== Tool 함수들 (필수 검증 + 요약 리턴) =====
def analyze_defect(defect_code: str, defect_description: str, process_step: str, equipment_id: str = None, wafer_id: str = None,
...
# ===== MCP Tools 정의 (15개) =====
TOOLS = [
    {"name": "analyze_defect", "description": "불량 분석(사용자 입력 기반)", "inputSchema": {"type": "object", "properties": {
        "defect_code": {"type": "string"}, "defect_description": {"type": "string"}, "process_step": {"type": "string"},
        "equipment_id": {"type": "string"}, "wafer_id": {"type": "string"},
        "known_causes": {"type": "array", "items": {"type": "string"}}, "recent_changes": {"type": "array", "items": {"type": "string"}}
    }, "required": ["defect_code", "defect_description", "process_step"]}},
    {"name": "get_defect_history", "description": "불량 이력 패턴 분석", "inputSchema": {"type": "object", "properties": {
        "defect_records": {"type": "array", "items": {"type": "object"}}, "analysis_type": {"type": "string"}
    }, "required": ["defect_records"]}},
    {"name": "suggest_corrective_action", "description": "시정 조치 가이드", "inputSchema": {"type": "object", "properties": {
        "problem_description": {"type": "string"}, "affected_equipment": {"type": "string"}, "severity": {"type": "string"},
        "current_status": {"type": "string"}, "available_resources": {"type": "array", "items": {"type": "string"}},
        "time_constraint": {"type": "string"}
    }, "required": ["problem_description", "affected_equipment", "severity", "current_status"]}},
    {"name": "compare_to_baseline", "description": "기준 레시피 대비 비교", "inputSchema": {"type": "object", "properties": {
        "baseline_recipe": {"type": "object"}, "current_recipe": {"type": "object"}, "recipe_name": {"type": "string"}
    }, "required": ["baseline_recipe", "current_recipe"]}},
    {"name": "compare_two_recipes", "description": "두 레시피 비교", "inputSchema": {"type": "object", "properties": {
        "recipe_a": {"type": "object"}, "recipe_b": {"type": "object"},
        "recipe_a_name": {"type": "string"}, "recipe_b_name": {"type": "string"}, "tolerance": {"type": "object"}
    }, "required": ["recipe_a", "recipe_b"]}},
    {"name": "validate_process_window", "description": "공정 윈도우 검증", "inputSchema": {"type": "object", "properties": {
        "process_window": {"type": "object"}, "test_conditions": {"type": "object"}, "critical_params": {"type": "array", "items": {"type": "string"}}
    }, "required": ["process_window", "test_conditions"]}},
    {"name": "analyze_metrics", "description": "메트릭 목표 대비 분석", "inputSchema": {"type": "object", "properties": {
        "metrics_data": {"type": "object"}, "targets": {"type": "object"}, "period": {"type": "string"}, "equipment_id": {"type": "string"}
    }, "required": ["metrics_data", "targets"]}},
    {"name": "analyze_spc_data", "description": "SPC 데이터 분석", "inputSchema": {"type": "object", "properties": {
        "data_points": {"type": "array", "items": {"type": "number"}}, "spec_limits": {"type": "object"},
        "control_limits": {"type": "object"}, "parameter_name": {"type": "string"}, "equipment_id": {"type": "string"}
    }, "required": ["data_points", "spec_limits"]}},
    {"name": "predict_defect_risk", "description": "불량 위험도 예측", "inputSchema": {"type": "object", "properties": {
        "process_window": {"type": "object"}, "current_conditions": {"type": "object"},
        "critical_params": {"type": "array", "items": {"type": "string"}}, "historical_defect_correlation": {"type": "object"}
    }, "required": ["process_window", "current_conditions"]}},
    {"name": "optimize_recipe_direction", "description": "레시피 최적화 방향 제안", "inputSchema": {"type": "object", "properties": {
        "current_recipe": {"type": "object"}, "current_performance": {"type": "object"}, "target_performance": {"type": "object"},
        "param_sensitivity": {"type": "object"}, "constraints": {"type": "object"}
    }, "required": ["current_recipe", "current_performance", "target_performance"]}},
    {"name": "simulate_parameter_change", "description": "파라미터 변경 시뮬레이션", "inputSchema": {"type": "object", "properties": {
        "current_state": {"type": "object"}, "proposed_changes": {"type": "object"}, "impact_rules": {"type": "array", "items": {"type": "object"}},
        "process_window": {"type": "object"}
    }, "required": ["current_state", "proposed_changes", "impact_rules"]}},
    {"name": "calculate_yield_impact", "description": "수율 영향 계산", "inputSchema": {"type": "object", "properties": {
        "baseline_yield": {"type": "number"}, "parameter_changes": {"type": "array", "items": {"type": "object"}},
        "interaction_effects": {"type": "array", "items": {"type": "object"}}
    }, "required": ["baseline_yield", "parameter_changes"]}},
    {"name": "analyze_equipment_comparison", "description": "장비 비교 분석", "inputSchema": {"type": "object", "properties": {
        "equipment_data": {"type": "array", "items": {"type": "object"}}, "weights": {"type": "object"}, "benchmark": {"type": "object"}
    }, "required": ["equipment_data"]}},
    {"name": "generate_shift_report", "description": "교대 리포트 생성", "inputSchema": {"type": "object", "properties": {
        "production_summary": {"type": "object"}, "equipment_status": {"type": "array", "items": {"type": "object"}},
        "quality_summary": {"type": "object"}, "key_events": {"type": "array", "items": {"type": "object"}},
        "pending_actions": {"type": "array", "items": {"type": "string"}}, "shift_info": {"type": "object"}
    }, "required": ["production_summary", "equipment_status", "quality_summary"]}},
    {"name": "analyze_trend", "description": "트렌드 분석", "inputSchema": {"type": "object", "properties": {
        "time_series_data": {"type": "array", "items": {"type": "object"}}, "parameter_name": {"type": "string"},
        "spec_limits": {"type": "object"}, "analysis_options": {"type": "object"}
    ...
    try:
        ...
        if method == "initialize":
            return JSONResponse({"jsonrpc": "2.0", "id": request_id, "result": {
                "protocolVersion": "2026-01-14", "capabilities": {"tools": {}}, "serverInfo": {"name": "SemiProcess MCP", "version": "2.0.0"}
            }})
